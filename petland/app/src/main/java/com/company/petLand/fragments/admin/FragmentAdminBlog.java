...
public class FragmentAdminBlog extends Fragment {
    private FragmentAdminBlogsBinding binding;
    List<Article> articles = new ArrayList<>();
    ArticlesAdapter adapter;

    public FragmentAdminBlog() {
    }

    public static FragmentAdminBlog newInstance() {
        return new FragmentAdminBlog();
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        adapter = new ArticlesAdapter(articles,this,true);
    }
