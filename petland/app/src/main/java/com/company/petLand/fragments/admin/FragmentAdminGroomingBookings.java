 ...
 * Use the {@link FragmentAdminGroomingBookings#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentAdminGroomingBookings extends Fragment {
    FragmentAdminBookingsBinding binding;
    ClientBookingsAdapter adapter;
    List<Booking> bookings = new ArrayList<>();


    public FragmentAdminGroomingBookings() {
    }


    public static FragmentAdminGroomingBookings newInstance() {
        return new FragmentAdminGroomingBookings();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Firebase.getGroomingBookingsRef().addValueEventListener(new ValueEventListener() {
            @Override
